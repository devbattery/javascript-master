...
const restaurant = {
  ...
  orderPizza(mainIngredirent, ...otherIngredients) {
...
console.log(rest.get(arr)); // Not Work [1, 2]
...
console.log(restaurant.orderResiotto?.(0, 1) ?? 'Method does not exist');

// Arrays
const users = [
  { name: 'Jonas', email: 'hello@jonas.io' },
  { name: 'Wonjun', email: 'hello@wonjun.io' },
];
